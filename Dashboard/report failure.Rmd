...
html_currency <- 
    ...
    read_proff_one(
      params$htmlfile,
      as.character(params$start), as.character(params$start)
    )
...
```{r revenue_expenses_plot_test, fig.asp=1, out.width="50%", fig.cap="Revenue and Expenses", fig.subcap=c("Based on the category \`Revenue' in the Excel sheet.", "Based on the category \`Expenses' in the Excel sheet.")}
## Revenue--------------------------------------------------------------------
revenue_plot <-
    exceldata |>
