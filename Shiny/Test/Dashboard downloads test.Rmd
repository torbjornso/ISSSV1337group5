...
Then upload an Excel file in the set format (available [here](https://github.com/amaliehc/ISSSV1337/blob/5c0a8a2beae499b3d2524a3965ceebf3b3ebad0e/Dashboard/Data/NGO_template.xltx)).
...
Enter the name of the NGO in the text box to include it in the report.

```{r sidebar_button}
textInput("name", "NGO name", value = "NGO name")
# download
uiOutput("downloadUI")
```
...
<b><font face="Georgia" size="3em" color="#000000">Chart B</font></b>
