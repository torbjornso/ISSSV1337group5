...
**Ca. 11 sider med all koden...** (Data reading hører kanskje hjemme et annet sted i rapporten? Eller kanskje som appendix, hvis vi får dårlig plass?)

- pygments, haddock, and kate are nice code syntax highlighting alternatives to the default (https://www.garrickadenbuie.com/blog/pandoc-syntax-highlighting-examples/)
