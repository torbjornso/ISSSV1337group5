...
**Ca. 12 sider med all koden...** (Data reading hører kanskje hjemme et annet sted i rapporten? Eller kanskje som appendix, hvis vi får dårlig plass?)
...
- More elegant to use lines (***) around the code blocks and one of the non-default syntax highlight styles, I think. (See first two blocks for example.)
