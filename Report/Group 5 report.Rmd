...
challenge is data acquisition, as data currently must be collected manually. They therefore wanted a way to automate data collection, for example using web scraping.
