...
<!-- # Legger inn to grafer som viser manglende data i Proffs årsregnskap-->

```{r arsresultat, echo=FALSE, out.width="70%", fig.align='center', fig.cap="Net income/loss data for the Norwegian Cancer Society from Proff.no"}
kreftforeningen |>
  rename(
    Year = year,
