...
the issue of financial statements not always being published as text, as well as their often wildly differing formats.
Unfortunately, we quickly found that Proff.no disallows any automated collection of data from their website. The Brønnøysund registry does offer API access to all the financial statements, but we discovered that access currently costs NOK 480,000.
...
```{r arsresultat, echo=FALSE, fig.align='center', fig.asp=0.5, fig.cap="Net income/loss data for the Norwegian Cancer Society from Proff.no"}
kreftforeningen |>
  rename(
    Year = year,
...
```{r egenkapital, echo=FALSE, fig.align='center', fig.asp=0.5, fig.cap="Total equity/liabilities data for the Norwegian Cancer Society from Proff.no"}
kreftforeningen |>
