...
As the dashboard uses a fair number of packages, it uses the pacman package to ensure they are installed, to avoid the user being confronted with (cryptic) messages about missing functions:
