...
- A webcrawler? <br> 
- No: Would not work for every organization <br> 
...
## <br> Phase 3 – Scrapping the scraping
- OPX wanted KPIs <br>
- Found useful KPIs <br>
- Created an interactive dashboard

## <br> Data collection & data description
- Used data from OPX and Proff.no <br>
- OPX: From their webpage. <br>
- Used to create KPIs and check our codes <br>
